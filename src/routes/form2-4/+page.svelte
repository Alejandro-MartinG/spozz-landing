...
<div class="cardo">
  ...
  <div class="card-body">
    <form class="content" method="POST" action="?/register">
        <label>Artist / Photographer Name<br>
        ...
        <label>Facebook<br>
            <input id="facebook" name="facebook" type="url" placeholder="    https://www.facebook.com/SPOZZ.club"/>
        </label>
        <label>Other Social Media<br>
            <input id="otherSocialMedia" name="otherSocialMedia" type="url" placeholder="    https://url.com"/>
        </label>
        <label>Instagram<br>
            <input id="instagram" name="instagram" type="url" placeholder="    https://www.instagram.com/spozz.club.nft"/>
        </label>
        <label>Twitter<br>
            <input id="twitter" name="twitter" type="url" placeholder="    https://twitter.com/spozzclubnft"/>
        </label>
        <label>Website<br>
            <input id="twitter" name="twitter" type="url" placeholder="    https://url.com"/>
        </label>
        <label>Comments<br>
            <input id="comments" name="comments" class="comment" type="text" placeholder=""/>
        </label>
